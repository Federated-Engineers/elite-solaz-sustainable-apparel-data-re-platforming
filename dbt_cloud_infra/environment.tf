resource "dbtcloud_environment" "prod" {
  ...
  credential_id = dbtcloud_snowflake_credential.dbt_cloud_snowflake_credentials.credential_id
...
resource "dbtcloud_environment" "slim_ci" {
  ...
  connection_id = dbtcloud_global_connection.dbt_cloud_snowflake_connection.id
  credential_id = dbtcloud_snowflake_credential.slim_ci_snowflake_credentials.credential_id
